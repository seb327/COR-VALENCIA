...
interface ParallaxImage { src: string; alt?: string; }
interface Props          { images: ParallaxImage[]; }

export function ZoomParallax({ images }: Props) {
    ...
    <div ref={container} className="relative h-[300vh]">
      <div className="sticky top-0 h-screen overflow-hidden">
        {images.map(({ src, alt }, index) => (
          ...
          >
            <div className="relative h-[25vh] w-[25vw] overflow-hidden rounded-2xl">
              <img
                src={src}
